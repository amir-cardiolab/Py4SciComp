...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            T= 0.7,  #0.84,
            dt=0.001/2,
            folder= 'AAA_results_test3', #'AAA_results_temp', #'AAA_results_backflow',
            velocity_degree=2,
            save_step=25,
            checkpoint=50,
            ...
            beta_backflow = 2.0 , # btwn 0 and 1 (50,100 works!)
...
def create_bcs(t,Time_array,v_IR_array, V, Q, mesh, **NS_namespace):
    # Specify boundary conditions
    
    #specify it in pre_solve_hook function below too.
    ...
    if (parabolic_flag):
     ...
     v_inlet_BC = numpy.interp(t, Time_array, v_IR_array)
...
def pre_solve_hook(mesh, velocity_degree, u_,
    ...
    return dict(uv=AssignedVectorFunction(u_),  facet_domains= facet_domains, n_normal=n_normal,Time_array=Time_array,v_IR_array=v_IR_array )
