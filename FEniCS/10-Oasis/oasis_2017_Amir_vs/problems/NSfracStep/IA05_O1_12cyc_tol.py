...
# Create a mesh
def mesh(**params):
    m = Mesh('/scratch/aa3878/IA_oasis/IA05_mesh.xml')
    #m = Mesh('/Users/aa3878/data/nonNewtonian/IA/C0005/model_croped_rotate-mesh-complete/mesh-surfaces/IA05_mesh.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            #T=  0.95*3,
            T=  0.95*15,
            dt= 0.95 /(2000. * 2.),     #0.95 /(2000. * 8.) , # 0.95 /(2000.*5.)
            folder= './../../../scratch/aa3878/IA_oasis/NewtO1_15_tol',
            velocity_degree=1,
            save_step= 40 * 2, #40 * 8, #40 * 5
            #save_start=32000,
            save_start=12000,  #48000,
            checkpoint=100*1e9,
            ...
            beta_backflow = 0., #0.5 , # btwn 0 and 1 (actually beta=2.0 and higher works!)
            ...
            flag_ramp = True, #for the first cycle only start from 0 flow rate at the inlet
...
def pre_solve_hook(mesh, velocity_degree, u_,
    ...
    bc_file =   '/scratch/aa3878/IA_oasis/BCnodeFacets.xml'
    #bc_file =  '/Users/aa3878/data/nonNewtonian/IA/C0005/model_croped_rotate-mesh-complete/mesh-surfaces/BCnodeFacets.xml'
    ...
    Time_array = IA05_BC.time_BC()
    v_IR_array = IA05_BC.Vel_IR_BC()
