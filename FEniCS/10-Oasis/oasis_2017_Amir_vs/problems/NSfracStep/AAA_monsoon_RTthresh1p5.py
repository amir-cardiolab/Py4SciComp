...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_RT",
            RT_thresh = 1.5,
            RT_filename = '/scratch/aa3878/18_oasis/PRT/P18bwdRT_RT.',
            #RT_filename = '/Users/aa3878/data/nonNewtonian/AAA18/results_oasis/final_O2/Newt/3rdcycle/PRT/P18bwdRT_RT.',
            nu=0.04/1.06,
            T= 1.053*3, #0.84
            dt=0.001053 /2.,
            folder= '../../../../scratch/aa3878/18_oasis/RT1p5',#'../nonNewtonian/AAA18/results_oasis/O1/nonNewt'
            #folder = '../nonNewtonian/AAA18/results_oasis/temp/temp',
            velocity_degree=2,
            save_step=40,
            save_start=4000,
            checkpoint=100*1e9,
