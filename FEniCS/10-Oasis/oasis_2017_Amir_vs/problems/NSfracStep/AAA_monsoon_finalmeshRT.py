...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_RT",
            RT_thresh = 1.5,
            RT_filename = '/scratch/aa3878/18_oasis/final_longer/PRT/P18bwdRT_RT.',
            nu=0.04/1.06,
            T= 1.053*3, #0.84
            dt=0.001053 /5.,
            folder= '../../../../scratch/aa3878/18_oasis/final_longer/RT1p5',#'../nonNewtonian/AAA18/results_oasis/O1/nonNewt'
            velocity_degree=2,
            save_step=100,
            save_start=10000,
            checkpoint=100*1e9,
