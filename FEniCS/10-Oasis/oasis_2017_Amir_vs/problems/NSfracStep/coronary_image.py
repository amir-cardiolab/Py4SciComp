...
def mesh(**params):
    ...
    #m = Mesh('/Users/aa3878/data/stenosis_ALE/Symon-models/iso-mesh-complete/mesh-surfaces/coronary_mesh.xml') #revision mesh and original paper mesh
    #m =  Mesh('/Users/aa3878/data/stenosis_ALE/Symon-models/growth_results/restart_50/restart50-mesh-complete/mesh-surfaces/coronary_mesh.xml') # restart mesh (original paper)
    m =  Mesh('/Users/aa3878/data/stenosis_ALE/Symon-models/revision/results2/restart50/restart_50-mesh-complete/mesh-surfaces/coronary_mesh.xml')#restart mesh for revision
...
def pre_solve_hook(jj,mesh,facet_domains, velocity_degree, u_,
