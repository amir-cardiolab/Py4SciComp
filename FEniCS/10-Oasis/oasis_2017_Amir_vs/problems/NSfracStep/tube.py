...
def mesh(**params):
    ...
    m = Mesh('/Users/aa3878/data/nonNewtonian/AAA18/tube-mesh-complete/mesh-surfaces/P18vel_mesh.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            T= 1.053*2, #0.84
            dt=0.001053 /2.,
            folder= '../nonNewtonian/AAA18/results_oasis/mesh_final/tube_serial',
            velocity_degree=1,
            save_step=40,
...
def pre_solve_hook(mesh, velocity_degree, u_,
    ...
    bc_file =  '/Users/aa3878/data/nonNewtonian/AAA18/tube-mesh-complete/mesh-surfaces/BCnodeFacets.xml'
